module.exports = function(app){
  ...
  */
  app.get('/api/codiv/paralisados', function(req, res){
    ...
    codivDAO.paralisados(filtro,function(erro, resultado){
     ...
     //    if(fim){
            links: [
              {
                href:"http://localhost:3000/codiv/paralisados?page="+proximaPagina+"&limit="+limit,
                rel:"next",
                method:"GET"
              }                
            ]
  ...
  app.get('/api/codiv/maiores_devedores', function(req, res){
    ...
    codivDAO.paralisados(filtro,function(erro, resultado){
      ...
      //     if(fim){
            links: [
              {
                href:"http://localhost:3000/codiv/maiores_devedores?page="+proximaPagina+"&limit="+limit,
                rel:"next",
                method:"GET"
              }                
            ]
